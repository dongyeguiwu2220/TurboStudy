...
-- ----------------------------
-- Table structure for enlesson_admin
-- ----------------------------
DROP TABLE IF EXISTS `enlesson_admin`;
CREATE TABLE `enlesson_admin`  (
...
INSERT INTO `enlesson_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 1735302901541, 0, 1734786380484);
